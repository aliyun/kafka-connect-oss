...
public class ParquetJsonFormat extends JsonFormat {
  public ParquetJsonFormat(OSSStorage storage) {
    super(storage);
  }

  @Override
  public RecordWriterProvider<OSSSinkConnectorConfiguration> getRecordWriterProvider() {
    return new ParquetJsonRecordWriterProvider(storage, converter);
  }
